...
❌ vectorstore/   (NOT there - will be created by ingest.py)
...
# 2. Check what would be committed (should NOT see .venv, app.db, vectorstore, __pycache__)
git status
...
| `vectorstore/` | ❌ Ignore | Will be rebuilt |
